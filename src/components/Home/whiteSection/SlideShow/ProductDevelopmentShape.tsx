...
const ProductDevelopmentShape: React.FC = () => {
  ...
  useEffect(() => {
    ...
    loader.load(
      '/assets/3DAssets/ProductDevelopment.glb',
      (gltf) => {
      ...
      undefined,
      (error) => {
        console.error('Error loading ProductDevelopment.glb:', error);
      }
    );
...
export default ProductDevelopmentShape;