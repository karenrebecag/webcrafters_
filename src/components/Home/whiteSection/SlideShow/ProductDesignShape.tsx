...
const ProductDesignShape: React.FC = () => {
  ...
  useEffect(() => {
    ...
    loader.load(
      '/assets/3DAssets/ProductDesign.glb',
      (gltf) => {
      ...
      undefined,
      (error) => {
        console.error('Error loading ProductDesign.glb:', error);
      }
    );
...
export default ProductDesignShape;