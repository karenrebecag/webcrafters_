...
const ThreeDIntelligenceShape: React.FC = () => {
  ...
  useEffect(() => {
    ...
    loader.load(
      '/assets/3DAssets/3DIntelligence.glb',
      (gltf) => {
      ...
      undefined,
      (error) => {
        console.error('Error loading 3DIntelligence.glb:', error);
      }
    );
...
export default ThreeDIntelligenceShape;